...
namespace Nop.Services.Messages
{
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected virtual string MATE_ProductListToHtmlTable(Order order, int languageId, int vendorId)
        {
            string result;
        ...
        public virtual void AddOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0)
        {
            ...
            tokens.Add(new Token("Order.MateProduct(s)", MATE_ProductListToHtmlTable(order, languageId, vendorId), true));
